        ...
        currentUser ? (
          <div className='flex flex-row gap-4'>
            ...
            <div className='w-full'>
              <textarea disabled={isLoading} onChange={(e) => setBody(e.target.value)} value={body} placeholder={placeholder}
              ...
              <div className='mt-4 flex flex-row justify-end'>
                <Button disabled={isLoading || !body} onClick={onSumbit} label='Tweet'></Button>
              </div>
            </div>
          </div>
        ) : (
