...
const PostItem: React.FC<Props> = ({userId, data}) => {
  ...
  const logonModal = useLoginModal();
  ...
  const onLink = useCallback((e: any) => {
    e.stopPropagation();
    if (!currentUser) {
      logonModal.onOpen()
    }
    ...
    toggleLike();
  },[logonModal, currentUser, toggleLike])
      ...
      <div className='flex flex-row items-start gap-3'>
        ...
        <div>
          ...
          <div className=' flex flex-row items-center mt-3 gap-10'>
            ...
            <div onClick={onLink} className='flex flex-row items-center text-neutral-500 gap-2 cursor-pointer transition hover:text-red-500'>
